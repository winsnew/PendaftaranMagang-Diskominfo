<x-app-layout>
    ...
    <form>
        ...
        <div class="p-8 lg:ml-64 bg-white h-full sm:flex mt-5 items-center border-b border-gray-300  dark:bg-gray-800 dark:border-gray-700">
            <div class="w-full">
                <div class="bg-white rounded-lg shadow-xl pb-8">
                    ...
                    <div class="flex flex-col items-center -mt-20">
                        <img src="https://api.duniagames.co.id/api/content/upload/file/8143860661599124172.jpg" class="w-40 border-4 border-white rounded-full">
                        <div class="flex items-center space-x-2 mt-2">
                            <p class="text-2xl">{{$data->nama}}</p>
                ...
                <div class="my-4 w-full 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
                    <div class=" flex flex-col lg:w-full">
                        <div class="grow bg-white rounded-lg shadow-xl p-8">
                            <h4 class="text-xl text-gray-900 font-bold">Personal Info</h4>
                            <ul class="mt-2 text-gray-700">
                                <li class="flex border-y py-2">
                                    <span class="font-bold w-24">Nama:</span>
                                    <span class="text-gray-700">{{$data->nama}}</span>
                                </li>
                                <li class="flex border-b py-2">
                                    <span class="font-bold w-24">Nim:</span>
                                    <span class="text-gray-700">{{$data->nim}}</span>
                                </li>
                                <li class="flex border-b py-2">
                                ...
                                <li class="flex border-b py-2">
                                    ...
                                    <span class="text-gray-700">0{{$data->nohp}}</span>
                                </li>
                                <li class="flex border-b py-2">
                                    <span class="font-bold w-24">Instansi:</span>
                                    <span class="text-gray-700">{{$data->Instansi}}</span>
                                </li>
                                <li class="flex border-b py-2">
                                    <span class="font-bold w-24">Jurusan:</span>
                                    <span class="text-gray-700">Informatika</span>
                                </li>
                                
                                <li class="flex items-center border-b py-2 space-x-2">
                                    <span class="font-bold w-24">Sosial Media:</span>
                                    <a href="#" title="Facebook">
                                        <svg class="w-5 h-5" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 506.86 506.86">
                                            ...
                                            <path class="cls-2" d="M352.08,326.69l11.23-73.26H293V205.89c0-20,9.81-39.58,41.3-39.58h31.95V104s-29-5-56.73-5c-57.88,0-95.72,35.08-95.72,98.6v55.83H149.48v73.26h64.35V503.78a256.11,256.11,0,0,0,79.2,0V326.69Z"></path>
                                        </svg>
                                    </a>
                                    <a href="#" title="Twitter">
                                        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 333333 333333" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd">
                                    ...
                                    <a href="#" title="Github">
                                        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="0" height="0" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 640 640">
